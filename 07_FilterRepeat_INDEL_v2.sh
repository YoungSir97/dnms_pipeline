...
# input variants file
inputVCF="/home/ubuntu/1.Project/DNMs/02.process.oldgenome/vcf/06_SelectVariants/ALLTrios_06_raw_INDEL.vcf.gz"
# input repeat bed
...
outputPath="/home/ubuntu/1.Project/DNMs/02.process.oldgenome/vcf/07_FilterRepeat/"
outputName="ALLTrios_raw_INDEL"  # If not set, the input file name will be used.
# samples number
sampleNumber=20
# report output path
pathREPORT="/home/ubuntu/1.Project/DNMs/02.process.oldgenome/vcf/07_FilterRepeat/report"
# other path
...
Rscript ${pathSCRIPT}/plot_VariantScores_SNP.R -s ${outputPath}/${outputName}_MaskedRepeat.table -o ${pathREPORT}/07_${outputName}_MaskedRepeat_VariantScores.pdf && \
...
Rscript ${pathSCRIPT}/plot_SampleDepth.R -i ${outputPath}/dp_MR.tmp -s 20 -o ${pathREPORT}/07_${outputName}_MaskedRepeat_SampleDepth && \
