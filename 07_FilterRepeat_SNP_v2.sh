...
# input variants file
inputVCF="/home/ubuntu/1.Project/DNMs/02.process.oldgenome/vcf/06_SelectVariants/ALLTrios_06_raw_SNP.vcf.gz"
# input repeat bed
...
outputName="ALLTrios_raw_SNP"  # If not set, the input file name will be used.
# samples number
sampleNumber=20
# report output path
