...
outputPath="/home/ubuntu/1.Project/DNMs/02.process.oldgenome/vcf/12_SelectVariants_bqsr"
outputName="ALLTrios_bqsr_raw"  # If not set, the input file name will be used.
# samples number
sampleNumber=20
# report output path
pathREPORT="/home/ubuntu/1.Project/DNMs/02.process.oldgenome/vcf/12_SelectVariants_bqsr/report/"
# other path
