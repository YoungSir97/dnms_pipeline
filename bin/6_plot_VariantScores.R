...
VCFsnps <- read.csv('/public/home/wanglab2021/1.Project/00.RawData_20210817/process/vcf/ALLTrios_mapped_fixmate_sorted_raw_SNPs.table', header = T, na.strings=c("","NA"), sep = "\t") 
VCFindel <- read.csv('/public/home/wanglab2021/1.Project/00.RawData_20210817/process/vcf/ALLTrios_mapped_fixmate_sorted_raw_INDELs.table', header = T, na.strings=c("","NA"), sep = "\t")
#dim(VCFsnps)
#dim(VCFindel)
