...
my $output0 = "$outdir/Step0_SelectTrios_output";
open SH0,">$outdir/Step0_SelectTrios.sh" || die $!;
print SH0 "#!/bin/bash\n\n";
...
foreach my $fam ( sort keys %trios){
    ...
    print SH0 "bcftools view -a -s $t[0],$t[1],$t[2] $vcf --output-type z -o $output0/$fam\_$t[0]_$t[1]_$t[2].Trios.vcf.gz && \\\nbcftools stats $output0/$fam\_$t[0]_$t[1]_$t[2].Trios.vcf.gz > $output0/$fam\_$t[0]_$t[1]_$t[2].Trios.vcf.gz.stat.txt\n\n";
